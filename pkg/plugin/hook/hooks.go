...
const (
	...
	CharacterCreatePost  TriggerEnum = "Character.Create.Post"
	CharacterUpdatePost  TriggerEnum = "Character.Update.Post"
	CharacterDestroyPost TriggerEnum = "Character.Destroy.Post"
)
